...
from ..serializers import PollSerializer, QuestionSerializer, UserOptionSerializer, \
        ...
        try:
            ...
            def makeAnswer(question):
                ...
                invalidIndexException = Exception(
                    'Invalid option index in answer to question %d' % question.id)
                ...
                if question.type == 'MULTIPLE_CHOICE':
                    ...
                    for index in answerData:
                        foundOption = next((o for o in optionList if o.index == index),
                                           None)
                        if foundOption:
